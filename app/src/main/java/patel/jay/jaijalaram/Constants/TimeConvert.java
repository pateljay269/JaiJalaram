...
public class TimeConvert implements Serializable {
    ...
    public static long date2Millies(String ddmmyy) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("dd-M-yyyy hh:mm:ss");
            String dateInString = ddmmyy + " 10:00:00";
